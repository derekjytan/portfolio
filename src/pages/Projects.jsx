      ...
      <div className="glass-panel p-6">
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/3">
            <div className="rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 h-full">
              <img
                src={project.iconUrl}
                alt={project.name}
              ...
              <div>
                ...
                {project.theme && (
                  <p className="text-sm uppercase tracking-[0.3em] text-gray-400 mt-1">
                    {project.theme.replace("btn-back-", "")}
                  </p>
                )}
              </div>
              <div className="flex gap-4 mt-2 md:mt-0 text-sm font-medium">
                {project.github && (
                  <a
                    href={project.github}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors"
                  >
                    <FaGithub />
